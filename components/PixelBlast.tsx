...
/* PixelBlast — React Bits (ts-tailwind variant), vendored as-is.
   rAF EXCEPTION (documented, per project invariant "ONE LOOP"):
   self-contained WebGL canvas with its own requestAnimationFrame; it never
   touches scroll logic or DOM outside its canvas, and autoPauseOffscreen
   (default true) halts it when out of the viewport. Same accepted exception
   as the BitCard tilt rAF (Act4) and LightRays (Hero). */
